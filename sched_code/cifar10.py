...
tf.app.flags.DEFINE_integer('deadline', 32,
                    """The size of the ResNet model to use.""")
tf.app.flags.DEFINE_integer('job_number', 0,
                    """The size of the job number to use.""")
tf.app.flags.DEFINE_string('method', 'test',
                    """The method to use.""")
