...
__BANDWD_MAX_SV_RES = (13.0 - 5.0) * 1024  # Max server resource for bandwidth, Mbit
__CPU_MAX_SV_RES = (5 * 2 + 5 - 5) * 500.0  # Max CPU resource for bandwidth, Mbit, 500 for each core, total
